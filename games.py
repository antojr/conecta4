...
def alphabeta_search(state, game, d, eval_fn, playerChoosed, difficultyLevel, cutoff_test=None):
    ...
    playerChoosed = game.to_move(state)

    def max_value(state, alpha, beta, depth):
        if cutoff_test(state, depth):
            return eval_fn(state,playerChoosed,difficultyLevel)
        v = -infinity
        for (a, s) in game.successors(state):
    ...
    eval_fn = eval_fn or (lambda state,playerChoosed,difficultyLevel: game.utility(state, playerChoosed))
